...
export const MENU_ITEM_CONFIGS: MenuItemConfig[] = [
  ...
  { key: 'deliveryNotes',   icon: 'car-outline',         color: '#4CAF50', bg: '#E8F5E9', route: '' },
  { key: 'inventory',       icon: 'cube-outline',        color: '#FF9800', bg: '#FFF3E0', route: '' },
  { key: 'cultivationLogs', icon: 'leaf-outline',        color: '#8BC34A', bg: '#F9FBE7', route: '' },
