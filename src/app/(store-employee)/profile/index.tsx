      ...
      <View style={styles.content}>
        ...
        <View style={styles.userCard}>
          ...
          <View style={styles.userInfo}>
            ...
            <View style={styles.roleBadge}>
              <Text style={styles.roleText}>{t('profile.roleStoreEmployee')}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.menuSection}>
          ...
          <TouchableOpacity style={styles.menuItem}>
            ...
            <Text style={styles.menuText}>{t('profile.myStores')}</Text>
            <Ionicons name="chevron-forward" size={20} color="#999" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.menuItem} onPress={() => router.push('/(store-employee)/profile/settings')}>
