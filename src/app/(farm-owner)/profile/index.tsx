    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.userCard}>
          ...
          <View style={styles.userInfo}>
            ...
            <View style={styles.roleBadge}>
              <Text style={styles.roleText}>{t('profile.roleFarmOwner')}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.menuSection}>
          ...
          <TouchableOpacity style={styles.menuItem}>
            <Ionicons name="leaf-outline" size={22} color="#333" />
            <Text style={styles.menuText}>{t('profile.myFarms')}</Text>
            <Ionicons name="chevron-forward" size={20} color="#999" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.menuItem} onPress={() => router.push('/(farm-owner)/profile/settings')}>
